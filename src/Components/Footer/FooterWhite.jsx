...
const FooterWhite = () => {
    return (
        ...
        <h6 style={{color:"#0071C2",fontSize:"16px",fontWeight:"700",cursor:"pointer"}}>Extranet login</h6>
        <div style={{width:"73%",margin:"auto",textAlign:"left",fontSize:"12px"}}>Copyright © 1996–2021 Booking.com™. All rights reserved.</div>
        <div style={{fontSize:"13px",padding:"15px",color:"#6B6B6B"}}>Booking.com is part of Booking Holdings Inc., the world leader in online travel and related services.</div>
        <div style={{padding:"19px",margin:"auto",width:"55%",display:"flex",justifyContent:"space-evenly"}}>
